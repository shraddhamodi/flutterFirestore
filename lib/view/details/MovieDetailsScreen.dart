              ...
              children: [
                ...
                Card(
                  child: Column(
                    children: [
                      ListTile(
                          title: MyTextView(movieData?.name ?? "NA",context.resources.color.colorPrimaryText,context.resources.dimension.bigText,),
                          subtitle: MyTextView(movieData?.salary.toString(),context.resources.color.colorSecondaryText,context.resources.dimension.mediumText,),
                          trailing: Row(
